...
public class PageBean {
    ...
    private int beginIndex;		//显示索引开始(包含)
    private int endIndex;		//显示索引结束(包含)
    ...
    public PageBean(int currentPage, int pageSize, int recordCount) {
        ...
        // 计算 beginIndex 和 endIndex
        if(recordCount<=pageSize){
            beginIndex = 1;
            endIndex = recordCount;
        }else{
            beginIndex = ((this.currentPage-1)*pageSize)+1;
