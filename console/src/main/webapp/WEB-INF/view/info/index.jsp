        ...
        <div id="container_1" class="container">
            ...
            <div class="item_box">
                <div class="item">
                    <h1>站内信息</h1>
                    <div class="mid">
                        <span class="mid_icon i_msg"></span>
                    ...
                    <a href="#"></a>
                    <a href="sitemsg" class="">链接</a>
                </div>
                <div class="item">
                    <h1>滚动公告</h1>
                    <div class="mid">
                        <span class="mid_icon i_notice"></span>
                    </div>
                    <a href="#"></a>
                    <a href="noticeList" class="">链接</a>
                </div>
                <div class="item">
                    <h1>活动信息</h1>
                    <div class="mid">
                        <span class="mid_icon i_act"></span>
                        <div class="mid_list fl">
                            <div class="list mgb20">
                                <span>4</span>
                                <p>展示中活动</p>
                    ...
                    <a href="#"></a>
                    <a href="addActivityInfo" class="">链接</a>
                </div>
                <div class="item">
                    <h1>政策文件</h1>
                    <div class="mid">
                        <span class="mid_icon i_file"></span>
                        <div class="mid_list fl"></div>
                    </div>
                    <a href="#"></a>
                    <a href="policy" class="">链接</a>
                </div>
                <div class="item">
                    <h1>新闻信息</h1>
                    <div class="mid">
                        <span class="mid_icon i_news"></span>
                        <div class="mid_list fl">
                            <div class="list mgb20">
                                <span>0</span>
                                <p>当天新闻</p>
