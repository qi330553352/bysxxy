    ...
    <div class="wrapper bg">
            ...
            <div class="page_container">
                <div class="page_search">
                    <div class="el-col el-col-5">
                        ...
                        <div class="dib">
                            <button class="sx_btn_orange">删除应用</button>
                            <button class="sx_btn_orange ml5">新建应用</button>
                        </div>
                    </div>
                    <div class="el-col el-col-6">
                        <div class="title_search el-input el-input--suffix">
                            <!---->
                            <input autocomplete="off" placeholder="请输入名称进行搜索" type="text" rows="2" validateevent="true" class="el-input__inner" />
                            <!---->
                    ...
                    <div class="el-table el-table--fit el-table--border" style="width: 100%;">
                        ...
                        <div class="el-table__header-wrapper">
                            <table cellspacing="0" cellpadding="0" border="0" class="el-table__header" style="width: 1230px;">
                                <colgroup>
                                    <col name="el-table_30_column_209" width="50" />
                                    <col name="el-table_30_column_210" width="200" />
                                    <col name="el-table_30_column_211" width="220" />
                                    <col name="el-table_30_column_212" width="220" />
                                    <col name="el-table_30_column_213" width="200" />
                                    <col name="el-table_30_column_214" width="120" />
                                    <col name="el-table_30_column_215" width="220" />
                                    <col name="gutter" width="0" />
                                </colgroup>
                                <thead class="has-gutter">
                                <tr class="">
                                    <th colspan="1" rowspan="1" class="el-table_30_column_209     is-leaf">
                                        <div class="cell"></div></th>
                                    <th colspan="1" rowspan="1" class="el-table_30_column_210     is-leaf">
                                        <div class="cell">
                                            应用名称
                                        </div></th>
                                    <th colspan="1" rowspan="1" class="el-table_30_column_211     is-leaf">
                                        <div class="cell">
                                            CLIENT-ID
                                        </div></th>
                                    <th colspan="1" rowspan="1" class="el-table_30_column_212     is-leaf">
                                        <div class="cell">
                                            注册邮箱
                                        </div></th>
                                    <th colspan="1" rowspan="1" class="el-table_30_column_213     is-leaf">
                                        <div class="cell">
                                            注册时间
                                        </div></th>
                                    <th colspan="1" rowspan="1" class="el-table_30_column_214     is-leaf">
                                        <div class="cell">
                                            状态
                                        </div></th>
                                    <th colspan="1" rowspan="1" class="el-table_30_column_215     is-hidden is-leaf">
                                        <div class="cell">
                                            操作
                                        </div></th>
                        ...
                        <!---->
                        <!---->
                        <div class="el-table__fixed-right" style="width: 220px; height: 368px;">
                            <div class="el-table__fixed-header-wrapper">
                                <table cellspacing="0" cellpadding="0" border="0" class="el-table__header" style="width: 220px;">
                                    <colgroup>
                                        <col name="el-table_30_column_209" width="50" />
                                        <col name="el-table_30_column_210" width="200" />
                                        <col name="el-table_30_column_211" width="220" />
                                    ...
                                    <thead class="">
                                    <tr class="">
                                        <th colspan="1" rowspan="1" class="el-table_30_column_209     is-hidden is-leaf">
                                            <div class="cell"></div></th>
                                        <th colspan="1" rowspan="1" class="el-table_30_column_210     is-hidden is-leaf">
                                            <div class="cell">
                                                应用名称
                                            </div></th>
                                        <th colspan="1" rowspan="1" class="el-table_30_column_211     is-hidden is-leaf">
                                            <div class="cell">
                                                CLIENT-ID
                                            </div></th>
                                        <th colspan="1" rowspan="1" class="el-table_30_column_212     is-hidden is-leaf">
                                            <div class="cell">
                                                注册邮箱
                                            </div></th>
                                        <th colspan="1" rowspan="1" class="el-table_30_column_213     is-hidden is-leaf">
                                            <div class="cell">
                                                注册时间
                                            </div></th>
                                        <th colspan="1" rowspan="1" class="el-table_30_column_214     is-hidden is-leaf">
                                            <div class="cell">
                                                状态
                                            </div></th>
                                        <th colspan="1" rowspan="1" class="el-table_30_column_215     is-leaf">
                                            <div class="cell">
                                                操作
                                            </div></th>
                                    </tr>
                            ...
                            <div class="el-table__fixed-body-wrapper" style="top: 48px;">
                                <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 220px;">
                                    <colgroup>
                                        <col name="el-table_30_column_209" width="50" />
                                        <col name="el-table_30_column_210" width="200" />
                                        <col name="el-table_30_column_211" width="220" />
        ...
        <div class="el-dialog__wrapper" style="display: none;">
            <div class="el-dialog" style="margin-top: 15vh;">
                <div class="el-dialog__header">
                    <span class="el-dialog__title">新建应用</span>
        ...
        <div class="el-dialog__wrapper" style="display: none;">
            <div class="el-dialog" style="width: 40%; margin-top: 15vh;">
                <div class="el-dialog__header">
                    <span class="el-dialog__title">应用详情</span>
                    <button type="button" aria-label="Close" class="el-dialog__headerbtn"><i class="el-dialog__close el-icon el-icon-close"></i></button>
                </div>
                <!---->
                <div class="el-dialog__footer">
